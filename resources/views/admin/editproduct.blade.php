        ...
        <div class="modal-content">
            ...
            <form action="{{ route('admin.editProduct', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" name="product_quantity" id="product_quantity" value="{{ $product->quantity }}"
                        class="form-control" min ="0">
                    <br>
                    <label for="product_price">Product Price</label>
                    <input type="text" name="product_price" id="product_price" value="{{ $product->price }}"
